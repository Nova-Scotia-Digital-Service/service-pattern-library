<div class="ns-form-group d-flex">
  <fieldset class="ns-fieldset">
    ...
    <div class="d-flex justify-content-start">
      ...
      <div class="pr-3"><label class="ns-label" for="day3">DD</label><input type="text" id="day3" name="day" class="fw-2" pattern="[0-9]*" inputmode="numeric" value="21"></div>
      <div class="pr-3"><label class="ns-label" for="month3">MM</label><input type="text" id="month3" name="month" class="fw-2" pattern="[0-9]*" inputmode="numeric" value="12"></div>
      <div class="pr-3"><label class="ns-label" for="year3">YYYY</label><input type="text" id="year3" name="year" class="fw-4" pattern="[0-9]*" inputmode="numeric" value="2021"></div>

      <div class="pr-3 align-self-end mb-2">
        <span>to</span>
      </div>

      <div class="pr-3"><label class="ns-label" for="day4">DD</label><input type="text" id="day4" name="day" class="fw-2" pattern="[0-9]*" inputmode="numeric" value="24"></div>
      <div class="pr-3"><label class="ns-label" for="month4">MM</label><input type="text" id="month4" name="month" class="fw-2" pattern="[0-9]*" inputmode="numeric" value="12"></div>
      <div class="pr-3"><label class="ns-label" for="year4">YYYY</label><input type="text" id="year4" name="year" class="fw-4" pattern="[0-9]*" inputmode="numeric" value="2021"></div>

      <div class="pr-3 align-self-end"><button class="btn-md ns-btn-2nd ns-btn__icon btn-inline-field"  type="button" data-toggle="collapse" data-target="#collapseCalendarPickerRange" aria-expanded="false" aria-controls="collapseCalendarPickerRange"><i class="far fa-calendar-alt ns-btn__icon-left" aria-hidden="true"></i>Select from calendar</button></div>

    </div>
  </fieldset>
</div>

<div class="collapse" id="collapseCalendarPickerRange">
      ...
      <div class="Calendar-grid">
        ...
        <section id="Calendar-dates" aria-label="Calendar dates" role="application">
          ...
          <div class="Calendar-row">
            ...
            <button type="button" aria-label="Wednesday December 16 2020" aria-pressed="false" class="Calendar-item Calendar-item--active" data-timestamp="1608091200" data-day="16" data-date="2020-12-16">16</button>
          ...
          <div class="Calendar-row">
            ...
            <button type="button" aria-label="Monday December 21 2020" aria-pressed="true" class="Calendar-item Calendar-item--active" data-timestamp="1608523200" data-day="21" data-date="2020-12-21">21</button>
            <button type="button" aria-label="Tuesday December 22 2020" aria-pressed="true" class="Calendar-item Calendar-item--active" data-timestamp="1608609600" data-day="22" data-date="2020-12-22">22</button>
            <button type="button" aria-label="Wednesday December 23 2020" aria-pressed="true" class="Calendar-item Calendar-item--active" data-timestamp="1608696000" data-day="23" data-date="2020-12-23">23</button>
            <button type="button" aria-label="Thursday December 24 2020" aria-pressed="true" class="Calendar-item Calendar-item--active" data-timestamp="1608782400" data-day="24" data-date="2020-12-24">24</button>
