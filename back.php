          ...
          <div class="col-sm-9 col-xs-12"><!-- Bootstrap column grid should not be set to more than 8-col for main content column -->
            ...
            <section class="row">
              <div class="col-md-12 col-xs-12">
                ...
                <ul class="nav nav-tabs" role="tablist">
                  <li class="nav-item">
                    <a id="exampleTabBack" class="nav-link active" href="#exampleBack" role="tab" data-toggle="tab">Example</a>
                  </li>
                  <li class="nav-item">
                ...
                <div class="exampleDisplay">
                  ...
                  <div class="tab-content">
                    ...
                    <div role="tabpanel" class="tab-pane fade" id="htmlBack">
                      ...
                      endwhile;
                      sort($files);
                      echo '<textarea rows="2" aria-labelledby="htmlTabBack">';
            ...
            <section class="row">
              <div class="col-md-12 col-xs-12">
                ...
                <ul class="nav nav-tabs" role="tablist">
                  <li class="nav-item">
                    <a id="exampleTabBackToStart" class="nav-link active" href="#exampleBackToStart" role="tab" data-toggle="tab">Example</a>
                  </li>
                  <li class="nav-item">
                    <a id="htmlTabBackToStart" class="nav-link" href="#htmlBackToStart" role="tab" data-toggle="tab">HTML</a>
                  </li>
                </ul>
                <div class="exampleDisplay">
                  <!-- Tab panes -->
                  <div class="tab-content">
                    ...
                    <div role="tabpanel" class="tab-pane fade" id="htmlBackToStart">
                      ...
                      endwhile;
                      sort($files);
                      echo '<textarea rows="1" aria-labelledby="htmlTabBackToStart">';
